...
namespace task {
    ...
    const std::vector<int> operator+(const std::vector<int> &v1) { return v1; }
    ...
    const double operator*(const std::vector<double> &v1,
                           const std::vector<double> &v2) {
        double res = 0;
        for (int i = 0; i < v1.size(); ++i)
            res += v1[i] * v2[i];
    ...
    const int operator*(const std::vector<int> &v1, const std::vector<int> &v2) {
        int res = 0;
        for (int i = 0; i < v1.size(); ++i)
            res += v1[i] * v2[i];
        return res;
